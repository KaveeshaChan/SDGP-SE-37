...
function EstimateCost() {
    return (
        ...
        <div className="sm: w-11/12 mt-1 sm:ml-14 xl:flex xl:w-11/12 lg:flex ">
            <div className="sm:w-96 sm:ml-0 lg:w-96  sm:min-h-80 lg:mt-8 sm:mt-4 justify-between bg-gray-800 rounded-xl xl:w-11/12 2xl:w-2/6  w-80 min-h-52 ml-8 2xl:ml-0  2xl:mt-2 ">ll</div>
            <div className="sm:mt-6 lg:mt-10 lg:ml-10 xl:ml-52 2xl:mt-20 ml-4 mt-4">
                ...
                <div className="sm:flex">
                    ...
                    <div>
                    <div className="sm:w-48 sm:ml-20 bg-gray-800 rounded-xl min-h-16 mt-4 mr-100 2xl:mt-0 2xl:ml-14  "></div>
                    </div>
                </div>
            </div>
        </div>
        <div className="sm:w-11/12 sm:ml-8 sm:mt-8 lg:mt-20 lg:min-h-44 xl:pl-10 xl:ml-14 xl:mt-10 bg-gray-800 ml-4 w-11/12 mt-8 rounded-xl min-h-36 2xl:w-3/6 2xl:mt-4 2xl:min-h-48 xl:min-h-44 xl:w-9/12">
