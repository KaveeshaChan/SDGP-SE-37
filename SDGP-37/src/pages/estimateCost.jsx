        ...
        <div className="sm: w-11/12 mt-1 sm:ml-14 xl:flex xl:w-11/12 lg:flex ">
            ...
            <div className="sm:mt-6 lg:mt-10 lg:ml-10 xl:ml-52 2xl:mt-20 ml-4 mt-4">
                ...
                <div className="sm:flex">
                    ...
                    <div>
                    <div className="sm:w-48 sm:ml-20 bg-[#37383A] rounded-xl min-h-16 mt-4 mr-100 2xl:mt-0 2xl:ml-14  "></div>
                    </div>
                </div>
            </div>
        </div>
        <div className="sm:w-11/12 sm:ml-8 sm:mt-8 lg:mt-20 lg:min-h-44 xl:pl-10 xl:ml-14 xl:mt-10 bg-[#37383A] ml-4 w-11/12 mt-8 rounded-xl min-h-36 2xl:w-3/6 2xl:mt-4 2xl:min-h-48 xl:min-h-44 xl:w-9/12">
