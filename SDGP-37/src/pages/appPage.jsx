...
export default function AppPage() {
  return (
    ...
    <div className=" w-4/5 min-w-min bg-gray-800 rounded-xl min-h-52 mt-4 ml-32">
    ...
    <div className="flex w-4/5 mt-5 ml-32 h-80">
      <section className='w-3/5 justify-between bg-gray-800 -mr-0.5 rounded-xl min-h-8'>
      ...
      <section className=" mb-2.5 text-black">
        ...
        <select name="brand" className="w-32 p-2.5 border border-solid border-white rounded-3xl text-xl bg-gray-500 ml-80 mt-2">
        ...
        <select name="type" className="w-32 p-2.5 border border-solid border-white rounded-3xl text-xl bg-gray-500 ml-80 mt-2">
