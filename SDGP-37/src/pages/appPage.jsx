...
export default function AppPage() {
  ...
  return (
    <>
      <div className="font-abc" style={{ backgroundColor: "#444548" }}>
        <div className=" sm:ml-20 sm:mt-20 lg:mt-24  w-80 min-w-min sm:w-10/12  bg-gray-800 rounded-xl min-h-32 mt-4 ml-10 xl:h-52 2xl:w-3/5 2xl:h-52 2xl:mt-8 md:min-h-40  md:mt-8 cursor-pointer" style={{ backgroundColor: "#37383A" }} >
        ...
        <div className="sm:ml-20 sm:mt-8 2xl:flex mt-10 xl:flex">
          ...
          <section
            ...
            style={{ backgroundColor: "#37383A" }} // Updated inline styling
          >
            {image ? (
          ...
          <section className='sm:w-5/5 mr-8 justify-between 2xl:pl-48 xl:flex'>
            ...
            <section className=" mt-8 ml-8  text-black"> 
              ...
              <select name="brand" className="sm:ml-10 sm:mt-4 w-32 p-2.5 border border-solid border-white rounded-3xl text-xl bg-gray-500 mt-2" style={{ backgroundColor: "#37383A" }} >
              ...
              <div className="flex ">
                <div>
                  <select name="type" className=" sm:ml-10 sm:mt-4 sm:text-xl w-32 p-2.5 border border-solid border-white rounded-3xl text-xl bg-gray-500 mt-2" style={{ backgroundColor: "#37383A" }} >
                ...
                <div>
                  <a href="/estmatedCost"><button className="sm:ml-28 sm:mt-6 w-32 p-2.5 border-white rounded-3xl text-xl bg-gray-500 mt-4 ml-8"style={{ backgroundColor: "#37383A" }} >Proceed</button></a>
                </div>
              </div>
