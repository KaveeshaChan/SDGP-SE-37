...
function HomePage(){
    return(
        <div>
            ...
            <div className="pr-10 sm:pt-4 md:pt-4 md:p-10 md:mr-40 xl:pl-0 xl:pt-24 xl:flex xl:justify-evenly  2xl:flex  2xl:pt-20  2xl:pl-2 ">
                <div className="text-white sm: pl-10 sm: pt-8 lg:ml-10  xl:mr-52">
                    <h2 className=" text-xl sm:text-2xl md:text-3xl lg:text-3xl lg:leading-10  xl:text-3xl 2xl:text-4xl 2xl:leading-tight "><b>VEHICLE DEAMAGE DETECTION AND  COST ESTIMATION</b></h2><br/>
