...
const Navbar = () => {
    ...
    return (
        ...
        <div>
          ...
          <div className={nav ? 'fixed left-0 top-0 w-72 h-full bg-black border-r border-r-black-900 ease-in-out duration-500' : 'fixed left-[-100%]'}>
          <ul className='pt-4'>
            <li><a className="text-4xl no-underline mr-20 ">FIXMATIC</a></li>
